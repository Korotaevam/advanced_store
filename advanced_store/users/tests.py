...
class UserRegistrationViewTestCase(TestCase):
    ...
    def setUp(self):  # общие значения
        self.data = {
            ...
            'username': 'user111', 'email': 'valerypavlikov@yandex.ru',
    ...
    def test_user_registration_get(self):
        ...
        self.assertEqual(response.context_data['title'], 'Stock - Registration')
    ...
    def test_user_registration_post_error(self):
        ...
        self.assertEqual(response.status_code, HTTPStatus.OK)
        # self.assertContains(response, 'A user with that username already exist', html=True)
